  ...
  return (
    <div className="flex flex-col items-center max-w-[1280px] justify-center mx-auto">
      ...
      <div className="md:px-16 w-full text-center  lg:text-[144px] md:text-[100px] sm:text-[60px] text-[44px] lg:leading-[158.4px] md:leading-[114.4px] sm:leading-[74.4px] leading-[64.4px] uppercase relative">
        <p className="md:text-9xl font-extrabold pt-16 text-white">
          METAVERSE
        </p>
        <div className=" inline-flex md:text-9xl font-extrabold text-white items-center md:py-4 py-2">
      ...
      {/* 图片 */}
      <motion.div className="md:px-16 min-h-[550px] sm:pl-8  relative w-full">
