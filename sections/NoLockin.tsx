export const NoLockin = () => (
    <section style={{}} className="relative h-screen bg-white py-96">
        ...
        <p className="mx-auto mt-20 max-w-[72rem] text-center text-xl text-black [&_a]:underline">
            I hope you learned something by watching this rebuild, the code and the video.
            Check out{' '}
            <a
            ...
            <a href="https://projects.codesandbox.io" rel="noopener nofollow noreferrer">
                CodeSandbo&#39; website
            </a>{' '}
            as well!
        </p>
